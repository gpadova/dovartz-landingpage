export const productsSpecificList = [
  {
    category: "Interruptores e Iluminação",
    title: "Smart Switches Touch e Teclas",
    src: "/products-list/switches.png",
    content: (
      <div className="space-y-4 text-gray-700 leading-relaxed">
        <p className="text-lg font-semibold text-gray-900 mb-3">
          Revolução no Controle da Iluminação
        </p>
        <p className="mb-4">
          Os interruptores inteligentes touch revolucionam o controle da
          iluminação em sua casa.Com design elegante e tecnologia de toque, eles
  ...
  {
    category: "Iluminação Inteligente",
    title: "Lâmpadas e Fitas de LED Inteligentes",
    src: "/products-list/leds.jpg",
    content: (
      <div className="space-y-4 text-gray-700 leading-relaxed">
        <p className="text-lg font-semibold text-gray-900 mb-3">
          Milhões de Cores e Funcionalidades Inteligentes
        </p>
        <p className="mb-4">
          As lâmpadas e fitas LED inteligentes transformam qualquer ambiente com
          milhões de cores e intensidades ajustáveis, oferecendo tanto beleza
        ...
        <div className="bg-gradient-to-r from-pink-50 to-blue-50 p-4 rounded-lg">
          ...
          <p className="text-gray-700 text-sm">
            ...
            visuais inteligentes • Grupos de iluminação personalizados • Rotinas
            automatizadas
          </p>
        </div>
      </div>
  ...
  {
    category: "Automação Central",
    title: "Central Zigbee e Gateway Zigbee",
    src: "/products-list/zigbee.png",
    content: (
      <div className="space-y-4 text-gray-700 leading-relaxed">
        <p className="text-lg font-semibold text-gray-900 mb-3">
        ...
        <p className="text-center text-sm text-gray-600 italic">
          Base para um ecossistema integrado e infinitamente expansível
        </p>
      </div>
    ),
  },
  {
    category: "Módulos de Automação",
    title: "Módulo Infravermelho e Relé para Cortinas",
    src: "/products-list/curtains.jpg",
    content: (
      <div className="space-y-4 text-gray-700 leading-relaxed">
        <p className="text-lg font-semibold text-gray-900 mb-3">
  ...
  },
  {
    ...
    title: "Painel HomePad com Tela Touch",
    src: "/products-list/panel.png",
    content: (
      <div className="space-y-4 text-gray-700 leading-relaxed">
        <p className="text-lg font-semibold text-gray-900 mb-3">
          Central de Comando da Casa Inteligente
        </p>
        <p className="mb-4">
          O painel HomePad centraliza o controle de toda automação em uma
          interface elegante e intuitiva, substituindo múltiplos controles por
        ...
        <p className="text-center text-sm font-medium text-gray-600 bg-gray-50 p-2 rounded">
          Como ter um mordomo digital na parede
        </p>
      </div>
    ),
  },
  {
    ...
    title: "Sistemas de Som: Yamaha, Harman Kardon, Denon, JBL, Frahm",
    src: "/products-list/sound.png",
    content: (
      <div className="space-y-4 text-gray-700 leading-relaxed">
        <p className="text-lg font-semibold text-gray-900 mb-3">
  ...
  {
    category: "Piso Aquecido",
    title: "Calefação programável e inteligente para banheiros e pisos",
    src: "/products/heated-floor.jpg",
    content: (
      <div className="space-y-4 text-gray-700 leading-relaxed">
        <p className="text-lg font-semibold text-gray-900 mb-3">
  ...
  {
    category: "Vigilância e Segurança",
    title:
      "Sensores de presença, fumaça, gás, CO, câmeras e alarmes inteligentes",
    src: "/products-list/alarm.jpg",
    content: (
      <div className="space-y-4 text-gray-700 leading-relaxed">
        <p className="text-lg font-semibold text-gray-900 mb-3">
  ...
  {
    category: "Comedouro Pet",
    title: "Alimentador programável para cães e gatos",
    src: "/products-list/pet-feeder.webp",
    content: (
      <div className="space-y-4 text-gray-700 leading-relaxed">
        <p className="text-lg font-semibold text-gray-900 mb-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          <div className="bg-blue-50 p-4 rounded-lg border-l-4 border-blue-400">
            ...
            <ul className="space-y-1 text-blue-800 text-sm">
              <li>• Câmera integrada para acompanhar </li>
              <li>• Notificações com fotos da refeição </li>
              <li>• Confirmação se o pet realmente comeu </li>
        ...
        <p className="text-center text-sm font-medium text-gray-600 bg-gray-50 p-2 rounded">
          ✈️ Essencial para tutores que viajam ou trabalham longas horas
        </p>
      </div>
    ),
  },
  {
    ...
    title: "Módulos de automação para todos os tipos de climatização",
    src: "/products/air-conditioner.webp",
    content: (
      <div className="space-y-4 text-gray-700 leading-relaxed">
        <p className="text-lg font-semibold text-gray-900 mb-3">
          Conforto Térmico Inteligente e Econômico
        </p>
        <p className="mb-4">
          Os módulos de climatização inteligente otimizam conforto térmico e
          economia de energia automaticamente, aprendendo seus hábitos e
          preferências.
        </p>
        ...
        <div className="bg-gradient-to-r from-cyan-50 to-blue-50 p-4 rounded-lg border-l-4 border-cyan-400">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
            <div className="bg-white bg-opacity-70 p-3 rounded">
              <div className="font-semibold text-orange-800 mb-1">🌞 Verão</div>
              <div className="text-orange-700">
                Pré-climatização 30min antes da chegada
              </div>
            </div>
            <div className="bg-white bg-opacity-70 p-3 rounded">
              <div className="font-semibold text-blue-800 mb-1">❄️ Inverno</div>
              <div className="text-blue-700">
                Aquecimento gradual pela manhã
              </div>
            </div>
          </div>
        </div>
  ...
  {
    category: "Rede Wi-Fi",
    title: "Sistemas de rede mesh para cobertura Wi-Fi ampla e estável",
    src: "/products-list/wifi.jpeg",
    content: (
      <div className="space-y-4 text-gray-700 leading-relaxed">
        <p className="text-lg font-semibold text-gray-900 mb-3">
  ...
  {
    category: "Persianas e Cortinas",
    title: "Motores automatizados com design e acessibilidade",
    src: "/products-list/motors.png",
    content: (
      <div className="space-y-4 text-gray-700 leading-relaxed">
        <p className="text-lg font-semibold text-gray-900 mb-3">
          Conforto, Economia e Segurança Automatizada
        </p>
        <p className="mb-4">
          As persianas e cortinas automatizadas oferecem controle inteligente da
          luminosidade e privacidade, com motores silenciosos que se integram
        ...
        <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-4 rounded-lg">
          ...
          <p className="text-gray-700 text-sm mb-3">
            Cortinas se abrem lentamente simulando nascer do sol natural,
  ...
  },
  {
    ...
    title: "Integração com Alexa Echo Dot, Echo Show 10/15",
    src: "/products-list/echo-show-15.jpeg",
    content: (
      <div className="space-y-4 text-gray-700 leading-relaxed">
        <p className="text-lg font-semibold text-gray-900 mb-3">
          Seu Mordomo Virtual Inteligente
        </p>
        <div className="bg-blue-50 p-4 rounded-lg mb-4">
          <h4 className="font-semibold text-blue-900 mb-2">
            🗣️ Controle Natural por Voz:
          </h4>
          <div className="bg-white bg-opacity-70 p-3 rounded mb-3">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-xs">
              <div className="text-center p-1">
                ...
                <div className="text-blue-700">Luzes apagam</div>
              </div>
              <div className="text-center p-1">
                <div className="text-blue-600">🔒</div>
                <div className="text-blue-700">Portas trancam</div>
              </div>
              <div className="text-center p-1">
                <div className="text-blue-600">🌡️</div>
                <div className="text-blue-700">Temperatura ajusta</div>
              </div>
              <div className="text-center p-1">
                <div className="text-blue-600">🔐</div>
                <div className="text-blue-700">Segurança ativa</div>
              </div>
            </div>
          </div>
        </div>
  ...
  {
    category: "Fechaduras Eletrônicas",
    title: "Controle de acesso facial e fechaduras digitais",
    src: "/products-list/digital-lock.jpg",
    content: (
      <div className="space-y-4 text-gray-700 leading-relaxed">
        <p className="text-lg font-semibold text-gray-900 mb-3">
          Segurança Avançada Sem Chaves
        </p>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
          <div className="bg-blue-50 p-3 rounded-lg text-center">
            <div className="text-blue-600 text-lg mb-1">👤</div>
  ...
  },
  {
    ...
    title: "Mapeamento e limpeza automática inteligente",
    src: "/products-list/cleaning-robot.jpg",
    content: (
      <div className="space-y-4 text-gray-700 leading-relaxed">
        <p className="text-lg font-semibold text-gray-900 mb-3">
          Sua Faxineira Digital 24/7
        </p>
        <div className="bg-blue-50 p-4 rounded-lg mb-4">
          <h4 className="font-semibold text-blue-900 mb-2">
          ...
          <p className="text-blue-800 text-sm mb-3">
            Sensores LiDAR criam mapa detalhado da casa, identificando móveis,
            tapetes e obstáculos com precisão
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-2 text-xs">
            <div className="bg-white bg-opacity-70 p-2 rounded text-center">
              <div className="font-bold text-blue-600">Zonas</div>
              <div className="text-blue-700">Específicas</div>
            </div>
            <div className="bg-white bg-opacity-70 p-2 rounded text-center">
              <div className="font-bold text-blue-600">Horários</div>
              <div className="text-blue-700">Por cômodo</div>
            </div>
            <div className="bg-white bg-opacity-70 p-2 rounded text-center">
              <div className="font-bold text-blue-600">Áreas</div>
              <div className="text-blue-700">Proibidas</div>
            </div>
          </div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        ...
        <p className="text-center text-sm font-medium text-gray-600 bg-gray-50 p-2 rounded">
          Como ter uma faxineira que trabalha discretamente mantendo tudo sempre
          impecável
        </p>
      </div>
    ),
  ...
  {
    category: "Espelhos Smart com LED",
    title: "Espelho com central inteligente e apps como Netflix",
    src: "/products-list/mirror.webp",
    content: (
      <div className="space-y-4 text-gray-700 leading-relaxed">
        <p className="text-lg font-semibold text-gray-900 mb-3">
